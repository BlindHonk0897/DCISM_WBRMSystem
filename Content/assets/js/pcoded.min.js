...
$('body').append('' +
    '<div class="fixed-button">' + '<a href="#" target="_blank" class="btn btn-md btn-primary" style="background-color:#0e3c00">' + '<i class="fa fa-globe" aria-hidden="true"></i> DCISM Networks' +
    '</a> ' + '</div>' + '');
var $window = $(window);
